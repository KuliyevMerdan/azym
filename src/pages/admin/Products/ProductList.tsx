    ...
    return(
        <div className="container my-4">
            ...
            <div className="row mb-3">
                <div className="col">
                    <Link to="/admin/products/create" className="btn btn-primary me-1 mb-2" role="button">Create Product</Link>
                            ...
                            return(
                                <tr key={index}>
                                    ...
                                    <td style={{ width: "10px", whiteSpace: "nowrap" }}>
                                        <Link to={"/admin/products/edit/" + product.id } className="btn btn-primary btn-sm me-1">Edit</Link>
